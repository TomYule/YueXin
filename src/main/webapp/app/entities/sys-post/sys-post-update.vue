    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="yueXinApp.sysPost.home.createOrEditLabel" v-text="$t('yueXinApp.sysPost.home.createOrEditLabel')">Create or edit a SysPost</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysPost.postCode')" for="sys-post-postCode">Post Code</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysPost.postName')" for="sys-post-postName">Post Name</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysPost.postSort')" for="sys-post-postSort">Post Sort</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysPost.status')" for="sys-post-status">Status</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysPost.createBy')" for="sys-post-createBy">Create By</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysPost.createTime')" for="sys-post-createTime">Create Time</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysPost.updateBy')" for="sys-post-updateBy">Update By</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysPost.upLocalDate')" for="sys-post-upLocalDate">Up Local Date</label>
                        <b-input-group class="mb-3">
                            <b-input-group-prepend>
                                <b-form-datepicker
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysPost.remark')" for="sys-post-remark">Remark</label>
