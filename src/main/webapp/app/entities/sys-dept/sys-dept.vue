    ...
    <div>
        <h2 id="page-heading">
            ...
            <router-link :to="{name: 'SysDeptCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-sys-dept">
                ...
                <span  v-text="$t('yueXinApp.sysDept.home.createLabel')">
        ...
        <div class="table-responsive" v-if="sysDepts && sysDepts.length > 0">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('yueXinApp.sysDept.deptName')">Dept Name</span></th>
                    <th><span v-text="$t('yueXinApp.sysDept.parentId')">Parent Id</span></th>
                    <th><span v-text="$t('yueXinApp.sysDept.ancestors')">Ancestors</span></th>
                    <th><span v-text="$t('yueXinApp.sysDept.orderNum')">Order Num</span></th>
                    <th><span v-text="$t('yueXinApp.sysDept.leader')">Leader</span></th>
                    <th><span v-text="$t('yueXinApp.sysDept.phone')">Phone</span></th>
                    <th><span v-text="$t('yueXinApp.sysDept.email')">Email</span></th>
                    <th><span v-text="$t('yueXinApp.sysDept.status')">Status</span></th>
                    <th><span v-text="$t('yueXinApp.sysDept.delFlag')">Del Flag</span></th>
                    <th><span v-text="$t('yueXinApp.sysDept.createBy')">Create By</span></th>
                    <th><span v-text="$t('yueXinApp.sysDept.createTime')">Create Time</span></th>
                    <th><span v-text="$t('yueXinApp.sysDept.updateBy')">Update By</span></th>
                    <th><span v-text="$t('yueXinApp.sysDept.upLocalDate')">Up Local Date</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
