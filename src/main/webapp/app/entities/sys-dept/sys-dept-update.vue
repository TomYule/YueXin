    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="yueXinApp.sysDept.home.createOrEditLabel" v-text="$t('yueXinApp.sysDept.home.createOrEditLabel')">Create or edit a SysDept</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysDept.deptName')" for="sys-dept-deptName">Dept Name</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysDept.parentId')" for="sys-dept-parentId">Parent Id</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysDept.ancestors')" for="sys-dept-ancestors">Ancestors</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysDept.orderNum')" for="sys-dept-orderNum">Order Num</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysDept.leader')" for="sys-dept-leader">Leader</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysDept.phone')" for="sys-dept-phone">Phone</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysDept.email')" for="sys-dept-email">Email</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysDept.status')" for="sys-dept-status">Status</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysDept.delFlag')" for="sys-dept-delFlag">Del Flag</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysDept.createBy')" for="sys-dept-createBy">Create By</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysDept.createTime')" for="sys-dept-createTime">Create Time</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysDept.updateBy')" for="sys-dept-updateBy">Update By</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysDept.upLocalDate')" for="sys-dept-upLocalDate">Up Local Date</label>
                        <b-input-group class="mb-3">
                            <b-input-group-prepend>
                                <b-form-datepicker
