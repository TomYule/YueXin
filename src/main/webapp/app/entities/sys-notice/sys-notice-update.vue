    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="yueXinApp.sysNotice.home.createOrEditLabel" v-text="$t('yueXinApp.sysNotice.home.createOrEditLabel')">Create or edit a SysNotice</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysNotice.noticeTitle')" for="sys-notice-noticeTitle">Notice Title</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysNotice.noticeType')" for="sys-notice-noticeType">Notice Type</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysNotice.noticeContent')" for="sys-notice-noticeContent">Notice Content</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysNotice.status')" for="sys-notice-status">Status</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysNotice.createBy')" for="sys-notice-createBy">Create By</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysNotice.createTime')" for="sys-notice-createTime">Create Time</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysNotice.updateBy')" for="sys-notice-updateBy">Update By</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysNotice.upLocalDate')" for="sys-notice-upLocalDate">Up Local Date</label>
                        <b-input-group class="mb-3">
                            <b-input-group-prepend>
                                <b-form-datepicker
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('yueXinApp.sysNotice.remark')" for="sys-notice-remark">Remark</label>
